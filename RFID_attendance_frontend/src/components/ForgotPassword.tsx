...
const ForgotPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await postData(`${API_BASE}/reset/request-reset`, { email });
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          ...
          setMessage('Reset link sent! Check your email and follow the instructions.');
        }, 3000);
      }

    } catch (error) {
      console.error('Reset request error:', error);
      setMessage('❌ Could not contact server. Check your internet or try again later.');
      setMessageType('error');
    } finally {
      setIsLoading(false);
    }
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={t('forgotPassword.email_placeholder') || 'Your Email'}
                    required
